...
🎓 **AI & Data Science | Machine Learning Enthusiast | Analytics Practitioner**  
📍 MIT ADT University, Pune, India  
📌 B.Tech in Computer Science (AI & Analytics)

I’m a curious and motivated engineering student passionate about turning data into actionable insights using **Data Science, Machine Learning, and AI**.

---

## 🚀 Tech Stack & Tools

### 💻 Data Science, Machine Learning & Analytics (Core)
...
### 🧠 Computer Vision & Deep Learning (Applied)
...
🎓 **Computer Science Engineering undergraduate** specializing in **Data Science, AI/ML, and Data Analytics**, with hands-on exposure to analytical and cloud-based workflows.

I enjoy applying data-driven and machine learning techniques to solve real-world problems. My key interests include:

- 📊 **Data Analysis & Visualization** — uncovering patterns and insights from structured datasets  
- 🤖 **Machine Learning & Predictive Modeling** — building, evaluating, and interpreting models  
- 🧠 **Deep Learning & Neural Networks** — applied CNNs and computer vision pipelines  
- 🔍 **Data-Driven Decision Making** — translating raw data into measurable outcomes  

I have a strong foundation in **Python, SQL, Java, and R**, with practical experience in:
...
<!-- Replace OR add dynamic links if you want -->
- **[2223965-bajaj](https://github.com/Kkj1203/2223965-bajaj)** – Python-based project with analytical logic  
- **[Weather-site](https://github.com/Kkj1203/Weather-site)** – JavaScript app with data fetching & UI  
- **[AssemblyCodes](https://github.com/Kkj1203/AssemblyCodes)** – Repository of assembly language implementations  
- **More in repos → 👇**
